...
export default function OfficeServicePage() {
  ...
  const faqs = [
    {
      question: t('office.faq1'),
      answer: t('office.faq1Answer'),
    },
    {
      question: t('office.faq2'),
      answer: t('office.faq2Answer'),
    },
    {
      question: t('office.faq3'),
      answer: t('office.faq3Answer'),
    },
    {
      question: t('office.faq4'),
      answer: t('office.faq4Answer'),
    },
  ];
      ...
      <section className="py-12 md:py-16 px-4 sm:px-6 md:px-8 lg:px-16 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 md:mb-8">
            {t('office.approachTitle')}
          </h2>
          <p className="text-base md:text-lg text-gray-600 leading-relaxed">
            {t('office.approachText')}
          </p>
        </div>
      </section>
