...
export default function ClinicServicePage() {
  ...
  const faqs = [
    {
      question: t('clinic.faq1'),
      answer: t('clinic.faq1Answer'),
    },
    {
      question: t('clinic.faq2'),
      answer: t('clinic.faq2Answer'),
    },
    {
      question: t('clinic.faq3'),
      answer: t('clinic.faq3Answer'),
    },
    {
      question: t('clinic.faq4'),
      answer: t('clinic.faq4Answer'),
    },
  ];
      ...
      <section className="py-12 md:py-16 px-4 sm:px-6 md:px-8 lg:px-16 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 md:mb-8">
            {t('clinic.approachTitle')}
          </h2>
          <p className="text-base md:text-lg text-gray-600 leading-relaxed mb-4">
            {t('clinic.approachText')}
          </p>
          <p className="text-base md:text-lg text-gray-600 leading-relaxed">
            {t('clinic.approachText2')}
          </p>
        </div>
      </section>
