...
export default function RetailServicePage() {
  ...
  const faqs = [
    {
      question: t('retail.faq1'),
      answer: t('retail.faq1Answer'),
    },
    {
      question: t('retail.faq2'),
      answer: t('retail.faq2Answer'),
    },
    {
      question: t('retail.faq3'),
      answer: t('retail.faq3Answer'),
    },
    {
      question: t('retail.faq4'),
      answer: t('retail.faq4Answer'),
    },
  ];
    ...
    <div className="w-full">
      ...
      <section className="relative min-h-[50vh] flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/services/store.webp"
            alt={t('retail.heroTitle')}
            fill
      ...
      <section className="py-12 md:py-16 px-4 sm:px-6 md:px-8 lg:px-16 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-base md:text-lg text-gray-600 leading-relaxed mb-4">
            {t('retail.approachText')}
          </p>
          <p className="text-base md:text-lg text-gray-600 leading-relaxed">
            {t('retail.approachText2')}
          </p>
        </div>
      </section>
